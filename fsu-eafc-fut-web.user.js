...
// @license      MIT
// @run-at       document-end
// @downloadURL https://raw.githubusercontent.com/jonghyunseo/fsu-fc26-enhancer/main/fsu-eafc-fut-web.user.js
// @updateURL https://raw.githubusercontent.com/jonghyunseo/fsu-fc26-enhancer/main/fsu-eafc-fut-web.user.js
// ==/UserScript==
...
(function () {
    ...
    function futweb() {
        ...
        //ea文本翻译
        const eafy = function(p){
            return info.base.localization[p] ?? p;
        }
        //本地化文本内容
        info.localization = {
            ...
            "clubplayers.tile.title":["我的球员","我的球員","My Players"],
            "clubplayers.tile.desc":["浏览俱乐部与SBC仓库中的球员。","瀏覽俱樂部與SBC倉庫中的球員。","Browse players in your Club and SBC Storage."],
            "clubplayers.scope":["俱乐部 + SBC仓库","俱樂部 + SBC倉庫","Club + SBC Storage"],
            "clubplayers.search":["搜索球员姓名","搜尋球員姓名","Search player name"],
            "clubplayers.filter.minovr":["最低评分","最低評分","Min OVR"],
            "clubplayers.filter.maxovr":["最高评分","最高評分","Max OVR"],
            "clubplayers.filter.position":["位置","位置","Position"],
            "clubplayers.filter.primary":["仅首选位置","僅首選位置","Primary only"],
            "clubplayers.filter.nation":["国家/地区","國家/地區","Nation"],
            "clubplayers.filter.league":["联赛","聯賽","League"],
            "clubplayers.filter.club":["俱乐部","俱樂部","Club"],
            "clubplayers.filter.rarity":["稀有度","稀有度","Rarity"],
            "clubplayers.filter.quality":["品质","品質","Quality"],
            "clubplayers.filter.skills":["花式动作","花式動作","Skill Moves"],
            "clubplayers.filter.weakfoot":["逆足","逆足","Weak Foot"],
            "clubplayers.filter.foot":["惯用脚","慣用腳","Strong Foot"],
            "clubplayers.filter.gender":["性别","性別","Gender"],
            "clubplayers.filter.location":["存放位置","存放位置","Location"],
            "clubplayers.filter.tradeable":["交易状态","交易狀態","Trade Status"],
            "clubplayers.filter.sort":["排序","排序","Sort"],
            "clubplayers.filter.columns":["列数","欄數","Columns"],
            "clubplayers.select.all":["全部","全部","All"],
            "clubplayers.quality.bronze":["青铜","青銅","Bronze"],
            "clubplayers.quality.silver":["白银","白銀","Silver"],
            "clubplayers.quality.gold":["黄金","黃金","Gold"],
            "clubplayers.quality.special":["特殊","特殊","Special"],
            "clubplayers.location.club":["俱乐部","俱樂部","Club"],
            "clubplayers.location.storage":["SBC仓库","SBC倉庫","SBC Storage"],
            "clubplayers.tradeable.yes":["可交易","可交易","Tradeable"],
            "clubplayers.tradeable.no":["不可交易","不可交易","Untradeable"],
            "clubplayers.foot.left":["左脚","左腳","Left"],
            "clubplayers.foot.right":["右脚","右腳","Right"],
            "clubplayers.gender.male":["男","男","Male"],
            "clubplayers.gender.female":["女","女","Female"],
            "clubplayers.sort.ratingdesc":["评分：高到低","評分：高到低","Rating: High to Low"],
            "clubplayers.sort.ratingasc":["评分：低到高","評分：低到高","Rating: Low to High"],
            "clubplayers.sort.nameasc":["姓名：A-Z","姓名：A-Z","Name: A-Z"],
            "clubplayers.sort.namedesc":["姓名：Z-A","姓名：Z-A","Name: Z-A"],
            "clubplayers.results":["%1 / %2 名球员","%1 / %2 名球員","%1 of %2 players"],
            "clubplayers.visible":["显示 %1 / %2","顯示 %1 / %2","Showing %1 of %2"],
            "clubplayers.reset":["重置筛选","重設篩選","Reset Filters"],
            "clubplayers.loadmore":["加载更多","載入更多","Load More"],
            "clubplayers.empty":["没有符合当前筛选条件的球员。","沒有符合目前篩選條件的球員。","No players match the current filters."],
            "clubplayers.detail.open":["查看 %1 的球员详情","檢視 %1 的球員詳情","View player details for %1"],
            "clubplayers.detail.info":["球员信息","球員資訊","Player Information"],
            "clubplayers.detail.attributes":["详细能力值","詳細能力值","Detailed Attributes"],
            "clubplayers.detail.playstyles":["比赛风格","比賽風格","PlayStyles"],
            "clubplayers.detail.playstyles.plus":["比赛风格+","比賽風格+","PlayStyles+"],
            "clubplayers.detail.playstyles.basic":["比赛风格","比賽風格","PlayStyles"],
            "clubplayers.detail.playstyles.empty":["没有比赛风格","沒有比賽風格","No PlayStyles"],
            "clubplayers.detail.rating":["总评","總評","Overall"],
            "clubplayers.detail.positions":["可选位置","可選位置","Alternate Positions"],
            "clubplayers.detail.height":["身高","身高","Height"],
            "clubplayers.detail.weight":["体重","體重","Weight"],
            "clubplayers.detail.bodytype":["体型","體型","Body Type"],
            ...
            "clubplayers.detail.face.pas":["传球","傳球","Passing"],
            "clubplayers.detail.face.dri":["盘带","盤帶","Dribbling"],
            "clubplayers.detail.face.def":["防守","防守","Defending"],
            "clubplayers.detail.face.phy":["身体","身體","Physical"],
            "clubplayers.detail.face.div":["扑救","撲救","Diving"],
            "clubplayers.detail.face.han":["手控球","手控球","Handling"],
            "clubplayers.detail.face.kic":["开球","開球","Kicking"],
        ...
        info.base.sytle += `
            ...
            .fsu-clubPlayersToolbarTop{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:12px}
            .fsu-clubPlayersSummary{display:flex;align-items:center;gap:10px;min-width:0}
            .fsu-clubPlayersResult{font-family:UltimateTeamCondensed,sans-serif;font-size:18px;font-weight:600;white-space:nowrap}
            .fsu-clubPlayersScope{padding:5px 9px 3px;border-radius:999px;background:#2f4a5b;color:#b9d9e7;font-family:UltimateTeamCondensed,sans-serif;font-size:12px;line-height:14px;white-space:nowrap}
            .fsu-clubPlayersActions{display:flex;align-items:center;gap:10px}
            .fsu-clubPlayersColumns{display:flex;align-items:center;gap:6px}
            .fsu-clubPlayersColumnsLabel{color:#a6a6a1;font-family:UltimateTeamCondensed,sans-serif;font-size:12px}
            .fsu-clubPlayersColumnButton,.fsu-clubPlayersReset,.fsu-clubPlayersLoadMore{min-height:0;border:1px solid #575753;background:#30312f;color:#fcfcfc;border-radius:7px;cursor:pointer;font-family:UltimateTeamCondensed,sans-serif}
            ...
            .fsu-clubPlayersControl--search{grid-column:span 2}
            .fsu-clubPlayersControl>label,.fsu-clubPlayersPrimaryLabel{color:#a6a6a1;font-family:UltimateTeamCondensed,sans-serif;font-size:12px;line-height:14px}
            .fsu-clubPlayersControl input:not([type="checkbox"]),.fsu-clubPlayersControl select{box-sizing:border-box;width:100%;height:36px;margin:0;border:1px solid #4d535b;border-radius:7px;outline:none;background:#242933;color:#fcfcfc;padding:0 10px;font-family:UltimateTeamCondensed,sans-serif;font-size:14px}
            .fsu-clubPlayersControl input:focus,.fsu-clubPlayersControl select:focus{border-color:#1fc3c1;box-shadow:0 0 0 2px rgba(31,195,193,.15)}
            .fsu-clubPlayersControl select option{background:#242933;color:#fcfcfc}
            .fsu-clubPlayersPositionRow{display:flex;align-items:center;gap:8px}
            .fsu-clubPlayersPositionRow select{flex:1;min-width:0}
            .fsu-clubPlayersPrimaryLabel{display:flex;align-items:center;gap:4px;color:#c6c9cc;white-space:nowrap;cursor:pointer}
            .fsu-clubPlayersPrimaryLabel input{accent-color:#07f468}
            ...
            .fsu-clubPlayersEmpty{display:none;max-width:640px;margin:64px auto;padding:28px;border:1px dashed #575753;border-radius:12px;color:#a6a6a1;text-align:center;font-family:UltimateTeamCondensed,sans-serif;font-size:18px}
            .fsu-clubPlayersDashboard.is-empty .fsu-clubPlayersEmpty{display:block}
            .fsu-clubPlayersDashboard.is-empty .fsu-clubPlayersGrid,.fsu-clubPlayersDashboard.is-empty .fsu-clubPlayersFooter{display:none}
            @media (max-width:1300px){.fsu-clubPlayersFilters{grid-template-columns:repeat(4,minmax(120px,1fr))}}
            @media (max-width:900px){.fsu-clubPlayersFilters{grid-template-columns:repeat(3,minmax(110px,1fr))}}
            .phone .fsu-clubPlayersToolbar{position:relative;padding:10px 8px}
            .phone .fsu-clubPlayersToolbarTop{align-items:flex-start;flex-direction:column}
            .phone .fsu-clubPlayersActions{width:100%;justify-content:space-between}
            .phone .fsu-clubPlayersFilters{grid-template-columns:repeat(2,minmax(0,1fr));gap:7px}
            .phone .fsu-clubPlayersControl--search{grid-column:span 2}
            .phone .fsu-clubPlayersPositionRow{align-items:flex-start;flex-direction:column;gap:4px}
            .phone .fsu-clubPlayersPrimaryLabel{height:18px}
            .phone .fsu-clubPlayersGrid{gap:7px;padding:8px}
            .phone .fsu-clubPlayersItem{border-radius:9px}
            .phone .fsu-clubPlayersCard{min-height:250px;padding:6px 2px 0;zoom:.58}
            .phone .fsu-clubPlayersGrid[data-columns="3"] .fsu-clubPlayersCard{zoom:.43}
            .phone .fsu-clubPlayersGrid[data-columns="4"] .fsu-clubPlayersCard{zoom:.34}
            .phone .fsu-clubPlayersMeta{gap:3px;padding:6px 3px}
            .phone .fsu-clubPlayersBadge{max-width:100%;overflow:hidden;padding:3px 4px 1px;font-size:10px;text-overflow:ellipsis}
            .fsu-clubPlayersCard{position:relative;cursor:pointer}
            ...
            .fsu-clubPlayerDetail::-webkit-scrollbar{width:8px}
            .fsu-clubPlayerDetail::-webkit-scrollbar-track{background:#23232b}
            ...
            .fsu-clubPlayerDetailSummary{display:flex;min-width:0;flex-direction:column;justify-content:center}
            .fsu-clubPlayerDetailEyebrow{margin-bottom:5px;color:#1fc3c1;font-size:12px;font-weight:700;letter-spacing:.14em;text-transform:uppercase}
            .fsu-clubPlayerDetailName{overflow:hidden;margin:0;color:#fcfcfc;font-family:UltimateTeam,sans-serif;font-size:34px;font-weight:700;line-height:1.08;text-overflow:ellipsis}
            .fsu-clubPlayerDetailIdentity{display:flex;flex-wrap:wrap;align-items:center;gap:8px;margin:12px 0 18px}
            .fsu-clubPlayerDetailRating{display:inline-grid;min-width:42px;height:38px;place-items:center;border-radius:8px;background:#f7b702;color:#171717;font-family:UltimateTeam,sans-serif;font-size:22px;font-weight:800}
            .fsu-clubPlayerDetailPill{padding:6px 9px 4px;border:1px solid #4d535b;border-radius:999px;background:#2d333d;color:#d7dadd;font-size:13px;line-height:14px;white-space:nowrap}
            .fsu-clubPlayerDetailPill--accent{border-color:#2e7350;background:#264a35;color:#8ff5a0}
            .fsu-clubPlayerDetailFaceGrid{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:7px;margin-bottom:18px}
            .fsu-clubPlayerDetailFace{display:flex;min-width:0;flex-direction:column;align-items:center;padding:9px 3px 6px;border:1px solid #3f444b;border-radius:9px;background:#262832}
            .fsu-clubPlayerDetailFaceValue{color:#fcfcfc;font-family:UltimateTeam,sans-serif;font-size:22px;font-weight:800;line-height:22px}
            .fsu-clubPlayerDetailFaceLabel{overflow:hidden;max-width:100%;margin-top:4px;color:#aeb3ba;font-size:11px;line-height:12px;text-overflow:ellipsis;text-transform:uppercase;white-space:nowrap}
            .fsu-statTone--elite{color:#07f468!important}
            .fsu-statTone--high{color:#7ce0df!important}
            .fsu-statTone--mid{color:#f7d36a!important}
            .fsu-statTone--low{color:#fd7254!important}
            .fsu-clubPlayerDetailFactGrid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}
            .fsu-clubPlayerDetailFact{min-width:0;padding:9px 10px 7px;border-left:2px solid #3f5967;background:rgba(45,51,61,.62)}
            .fsu-clubPlayerDetailFactLabel{overflow:hidden;color:#949ba3;font-size:11px;line-height:12px;text-overflow:ellipsis;text-transform:uppercase;white-space:nowrap}
            .fsu-clubPlayerDetailFactValue{overflow:hidden;margin-top:3px;color:#f1f2f3;font-size:15px;line-height:17px;text-overflow:ellipsis;white-space:nowrap}
            .fsu-clubPlayerDetailContent{display:flex;flex-direction:column;gap:24px;padding:24px}
            .fsu-clubPlayerDetailSection{min-width:0}
            .fsu-clubPlayerDetailSectionHeader{display:flex;align-items:center;justify-content:space-between;gap:12px;margin:0 0 11px;padding-bottom:8px;border-bottom:1px solid #3f444b}
            .fsu-clubPlayerDetailSectionTitle{margin:0;color:#fcfcfc;font-family:UltimateTeam,sans-serif;font-size:18px;font-weight:700}
            .fsu-clubPlayerDetailSectionCount{padding:4px 7px 2px;border-radius:999px;background:#30353e;color:#aeb3ba;font-size:12px}
            .fsu-clubPlayerDetailStyleGroups{display:grid;grid-template-columns:1fr 1fr;gap:12px}
            .fsu-clubPlayerDetailStyleGroup{min-width:0;padding:12px;border:1px solid #3f444b;border-radius:12px;background:#24252d}
            .fsu-clubPlayerDetailStyleTitle{display:flex;align-items:center;justify-content:space-between;margin-bottom:9px;color:#b7bcc2;font-size:13px;text-transform:uppercase}
            .fsu-clubPlayerDetailStyleList{display:flex;flex-wrap:wrap;gap:7px}
            .fsu-clubPlayerDetailStyleChip{display:flex;min-width:0;align-items:center;gap:7px;padding:6px 9px 5px;border:1px solid #48505a;border-radius:999px;background:#30353e;color:#eceeef;font-size:13px;line-height:16px}
            .fsu-clubPlayerDetailStyleChip--plus{border-color:#7b6426;background:linear-gradient(135deg,#53461f,#302b21);color:#ffe48a}
            .fsu-clubPlayerDetailStyleChip i{position:relative;flex:0 0 auto;font-size:22px;line-height:22px}
            .fsu-clubPlayerDetailStyleChip span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
            .fsu-clubPlayerDetailStyleEmpty{color:#858b92;font-size:13px}
            .fsu-clubPlayerDetailAttributeGrid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px}
            .fsu-clubPlayerDetailAttributeGroup{min-width:0;padding:13px;border:1px solid #3f444b;border-radius:12px;background:#24252d}
            .fsu-clubPlayerDetailAttributeHead{display:flex;align-items:baseline;justify-content:space-between;gap:10px;margin-bottom:10px}
            .fsu-clubPlayerDetailAttributeName{color:#c3c8ce;font-size:14px;font-weight:700;text-transform:uppercase}
            .fsu-clubPlayerDetailAttributeValue{font-family:UltimateTeam,sans-serif;font-size:25px;font-weight:800}
            .fsu-clubPlayerDetailSubStats{display:flex;flex-direction:column;gap:8px}
            .fsu-clubPlayerDetailSubStat{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:3px 8px;align-items:center}
            .fsu-clubPlayerDetailSubStatLabel{overflow:hidden;color:#aeb3ba;font-size:13px;line-height:14px;text-overflow:ellipsis;white-space:nowrap}
            .fsu-clubPlayerDetailSubStatValue{color:#e7e9eb;font-family:UltimateTeam,sans-serif;font-size:14px;font-weight:700}
            .fsu-clubPlayerDetailSubStatBar{grid-column:1/-1;height:3px;overflow:hidden;border-radius:3px;background:#3a3d45}
            ...
            .phone .fsu-clubPlayerDetailCardStage>.large{zoom:.88}
            .phone .fsu-clubPlayerDetailName{font-size:28px}
            .phone .fsu-clubPlayerDetailIdentity{margin:9px 0 13px}
            .phone .fsu-clubPlayerDetailFaceGrid{grid-template-columns:repeat(3,minmax(0,1fr));gap:6px}
            .phone .fsu-clubPlayerDetailFactGrid{grid-template-columns:repeat(2,minmax(0,1fr));gap:6px}
            .phone .fsu-clubPlayerDetailContent{gap:20px;padding:16px 12px}
        ...
        UTClubHubView.prototype.clearTileContent = function(...args) {
            ...
            const clubPlayerCount = events.getClubPlayerDashboardRecords().length;
            if("_fsuClubPlayersTile" in this){
                this.addTileStats(this._fsuClubPlayersTile,clubPlayerCount);
            }else{
                let clubPlayersTile = new UTTileView();
                clubPlayersTile.getRootElement().classList.add("col-1-2");
                clubPlayersTile.getRootElement().classList.add("ut-tile-view--with-gfx");
                clubPlayersTile.getRootElement().classList.add("fsu-clubplayers");
                clubPlayersTile.init();
                clubPlayersTile.title = fy("clubplayers.tile.title");
                clubPlayersTile.getRootElement().setAttribute("title",fy("clubplayers.tile.desc"));
                clubPlayersTile._parent = this;
                this._fsuClubPlayersTile = clubPlayersTile;
                this._fsuClubPlayersTile.addTarget(this,
                    () => {
                        events.goToClubPlayers()
                    },EventType.TAP)
                this._fsuClubPlayersTile.setInteractionState(true);
                this.addTileStats(this._fsuClubPlayersTile,clubPlayerCount);
                this.getRootElement().querySelector("div.grid").appendChild(this._fsuClubPlayersTile.getRootElement());
            }
        }
        ...
        events.goToClubPlayers = () => {
            let nav = cntlr.current().getNavigationController();
            if(nav){
                nav.pushViewController(new clubPlayersController());
            }
        }
        ...
        //26.09.4 俱乐部球员仪表盘和球员详情弹窗
        events.normalizeClubPlayerSearchText = (value) => {
            return String(value ?? "")
                .normalize("NFD")
                .replace(/[\u0300-\u036f]/g, "")
                .toLocaleLowerCase();
        }
        events.getClubPlayerQuality = (player) => {
            if(player?.isSpecial?.()){
                return "special";
            }
            if(player?.isBronzeRating?.()){
                return "bronze";
            }
            if(player?.isSilverRating?.()){
                return "silver";
            }
            if(player?.isGoldRating?.()){
                return "gold";
            }
            const rating = Number(player?.rating ?? 0);
            return rating <= 64 ? "bronze" : rating <= 74 ? "silver" : "gold";
        }
        events.getClubPlayerDashboardRecords = () => {
            ...
            const sources = [
                {
                    location: "club",
                    items: repositories.Item?.club?.items?.values?.() ?? []
                },
                {
                    location: "storage",
                    items: repositories.Item?.getStorageItems?.() ?? repositories.Item?.storage?.values?.() ?? []
                }
            ];

            _.forEach(sources, source => {
                _.forEach(source.items, (player, index) => {
                    if(!player?.isPlayer?.() || player.concept){
                        return;
                    }
                    const itemKey = player.id !== undefined && player.id !== null
                        ? String(player.id)
                        : `${source.location}-${player.definitionId}-${index}`;
                    if(seen.has(itemKey)){
                        return;
                    }
                    seen.add(itemKey);
                    ...
                    const name = String(staticData?.name ?? player.name ?? player.definitionId ?? "");
                    const positions = Array.isArray(player.possiblePositions)
                        ? player.possiblePositions.slice()
                        : [];
                    if(player.preferredPosition !== undefined && player.preferredPosition !== null && !positions.includes(player.preferredPosition)){
                        positions.unshift(player.preferredPosition);
                    }
                    ...
                    records.push({
                        ...
                        name,
                        searchName: events.normalizeClubPlayerSearchText(name),
                        ...
                        club: player.teamId,
                        rarity: player.rareflag,
                        quality: events.getClubPlayerQuality(player),
                        skillMoves: Number(player.getSkillMoves?.() ?? 0),
                        weakFoot: Number(player.getWeakFoot?.() ?? 0),
                        foot: player.isLeftFoot?.() ? "left" : "right",
                        gender: Number(player.gender ?? 0) === 1 ? "female" : "male",
        ...
        events.filterClubPlayerDashboardRecords = (records, state) => {
            const query = events.normalizeClubPlayerSearchText(state.query);
            const minRating = state.minRating === "" ? null : Math.max(0, Math.min(99, Number(state.minRating)));
            const maxRating = state.maxRating === "" ? null : Math.max(0, Math.min(99, Number(state.maxRating)));
            const filtered = records.filter(record => {
                if(query && !record.searchName.includes(query)){
                    return false;
                }
                if(minRating !== null && record.rating < minRating){
                    return false;
                }
                if(maxRating !== null && record.rating > maxRating){
                    return false;
                }
                if(state.position){
                    const positions = state.primaryOnly ? [record.position] : record.positions;
                    if(!positions.some(position => String(position) === state.position)){
                        return false;
                    }
                }
                if(state.nation && String(record.nation) !== state.nation){
                    return false;
                }
                if(state.league && String(record.league) !== state.league){
                    return false;
                }
                if(state.club && String(record.club) !== state.club){
                    return false;
                }
                if(state.rarity && String(record.rarity) !== state.rarity){
                    return false;
                }
                if(state.quality && record.quality !== state.quality){
                    return false;
                }
                if(state.skillMoves && String(record.skillMoves) !== state.skillMoves){
                    return false;
                }
                if(state.weakFoot && String(record.weakFoot) !== state.weakFoot){
                    return false;
                }
                if(state.foot && record.foot !== state.foot){
                    return false;
                }
                if(state.gender && record.gender !== state.gender){
                    return false;
                }
                if(state.location && record.location !== state.location){
                    return false;
                }
                if(state.tradeable === "yes" && !record.tradeable){
                    return false;
                }
                if(state.tradeable === "no" && record.tradeable){
                    return false;
                }
                return true;
            });
            ...
            filtered.sort((a, b) => {
                if(state.sort === "rating-asc"){
                    return a.rating - b.rating || nameCompare(a, b);
                }
                if(state.sort === "name-asc"){
                    return nameCompare(a, b) || b.rating - a.rating;
                }
                if(state.sort === "name-desc"){
                    return nameCompare(b, a) || b.rating - a.rating;
                }
                return b.rating - a.rating || Number(b.rarity ?? 0) - Number(a.rarity ?? 0) || nameCompare(a, b);
            });
            return filtered;
        }
        ...
        events.getClubPlayerStatValue = (player, attributeId, faceAttribute = false) => {
            try {
                const rawValue = faceAttribute
                    ? player.getAttribute?.(attributeId)
                    : player.getSubAttribute?.(attributeId);
                const value = rawValue?.rating
                    ?? (typeof rawValue?.value === "function" ? rawValue.value() : rawValue?.value)
                    ?? rawValue;
                const number = Number(value);
                return Number.isFinite(number) ? Math.max(0, Math.min(99, number)) : null;
            } catch(error) {
                return null;
            }
        }
        events.getClubPlayerStatTone = (value) => {
            if(!Number.isFinite(value)){
                return "";
            }
            if(value >= 90){
                return "fsu-statTone--elite";
            }
            if(value >= 80){
                return "fsu-statTone--high";
            }
            if(value >= 70){
                return "fsu-statTone--mid";
            }
            return "fsu-statTone--low";
        }
        events.getClubPlayerSubAttributeLabels = () => {
            return new Map([
                [ItemSubAttribute.acceleration, ["acceleration", "Acceleration"]],
                [ItemSubAttribute.sprintspeed, ["sprintspeed", "Sprint Speed"]],
                [ItemSubAttribute.positioning, ["positioning", "Att. Position"]],
                [ItemSubAttribute.finishing, ["finishing", "Finishing"]],
                [ItemSubAttribute.shotpower, ["shotpower", "Shot Power"]],
                [ItemSubAttribute.longshots, ["longshots", "Long Shots"]],
                [ItemSubAttribute.volleys, ["volleys", "Volleys"]],
                [ItemSubAttribute.penalties, ["penalties", "Penalties"]],
                [ItemSubAttribute.vision, ["vision", "Vision"]],
                [ItemSubAttribute.crossing, ["crossing", "Crossing"]],
                [ItemSubAttribute.freekickaccuracy, ["freekickaccuracy", "FK Accuracy"]],
                [ItemSubAttribute.shortpassing, ["shortpassing", "Short Passing"]],
                [ItemSubAttribute.longpassing, ["longpassing", "Long Passing"]],
                [ItemSubAttribute.curve, ["curve", "Curve"]],
                [ItemSubAttribute.agility, ["agility", "Agility"]],
                [ItemSubAttribute.balance, ["balance", "Balance"]],
                [ItemSubAttribute.reactions, ["reactions", "Reactions"]],
                [ItemSubAttribute.ballcontrol, ["ballcontrol", "Ball Control"]],
                [ItemSubAttribute.dribbling, ["dribbling", "Dribbling"]],
                [ItemSubAttribute.composure, ["composure", "Composure"]],
                [ItemSubAttribute.interceptions, ["interceptions", "Interceptions"]],
                [ItemSubAttribute.headingaccuracy, ["headingaccuracy", "Heading Accuracy"]],
                [ItemSubAttribute.marking, ["marking", "Def. Awareness"]],
                [ItemSubAttribute.standingtackle, ["standingtackle", "Standing Tackle"]],
                [ItemSubAttribute.slidingtackle, ["slidingtackle", "Sliding Tackle"]],
                [ItemSubAttribute.jumping, ["jumping", "Jumping"]],
                [ItemSubAttribute.stamina, ["stamina", "Stamina"]],
                [ItemSubAttribute.strength, ["strength", "Strength"]],
                [ItemSubAttribute.aggression, ["aggression", "Aggression"]],
                [ItemSubAttribute.gkdiving, ["gkdiving", "GK Diving"]],
                [ItemSubAttribute.gkhandling, ["gkhandling", "GK Handling"]],
                [ItemSubAttribute.gkkicking, ["gkkicking", "GK Kicking"]],
                [ItemSubAttribute.gkreflexes, ["gkreflexes", "GK Reflexes"]],
                [ItemSubAttribute.gkpositioning, ["gkpositioning", "GK Positioning"]]
            ]);
        }
        events.getClubPlayerPlayStyleName = (style) => {
            const callableNames = ["getLocalizedName", "getDisplayName", "getName"];
            for(const method of callableNames){
                try {
                    const value = style?.[method]?.(services.Localization);
                    if(typeof value === "string" && value.trim()){
                        return events.getClubPlayerSafeLocalized([value], value);
                    }
                } catch(error) {
                    // Continue through the remaining name sources.
                }
            }
            const directName = style?.localizedName ?? style?.displayName ?? style?.name ?? style?.label ?? style?.title;
            if(typeof directName === "string" && directName.trim()){
                return events.getClubPlayerSafeLocalized([directName], directName);
            }

            const traitId = Number(style?.traitId);
            if(typeof PlayerTrait !== "undefined" && Number.isFinite(traitId)){
                const enumName = Object.keys(PlayerTrait).find(key => {
                    return !/^\d+$/.test(key) && Number(PlayerTrait[key]) === traitId;
                });
                if(enumName){
                    return _.startCase(enumName
                        .replace(/^PLAYSTYLE_/, "")
                        .replace(/1_V_1/g, "1v1")
                        .toLowerCase());
                }
            }
            return Number.isFinite(traitId) ? `PlayStyle ${traitId}` : fy("clubplayers.detail.playstyles");
        }
        events.getClubPlayerPlayStyles = (player) => {
            const safeStyles = (method) => {
                try {
                    const styles = player?.[method]?.();
                    return Array.isArray(styles) ? styles.filter(Boolean) : [];
                } catch(error) {
                    return [];
                }
            };
            const loadedStyles = safeStyles("getPlayStyles");
            const allStyles = loadedStyles.length
                ? loadedStyles
                : (Array.isArray(player?._playStyles) ? player._playStyles.filter(Boolean) : []);
            let plus = safeStyles("getPlusPlayStyles");
            let basic = safeStyles("getBasicPlayStyles");
            if(!plus.length){
                plus = allStyles.filter(style => Boolean(style?.isIcon));
            }
            if(!basic.length){
                basic = allStyles.filter(style => !style?.isIcon);
            }

            const uniqueStyles = (styles) => {
                const seen = new Set();
                return _.orderBy(styles.filter(style => {
                    const key = String(style?.traitId ?? "");
                    if(seen.has(key)){
                        return false;
                    }
                    seen.add(key);
                    return true;
                }), ["category", "traitId"], ["asc", "asc"]);
            };
            plus = uniqueStyles(plus);
            const plusIds = new Set(plus.map(style => String(style?.traitId ?? "")));
        ...
        events.getClubPlayerDetailData = (record) => {
            ...
            const getPositionName = (position) => {
                ...
                try {
                    return UTLocalizationUtil.positionIdToName(position, services.Localization) || info.posIdToName[position] || String(position);
                } catch(error) {
                    return info.posIdToName[position] || String(position);
                }
            };
            const getEntityName = (type, value) => {
                if(value === undefined || value === null){
                    return "—";
                }
                try {
                    if(type === "nation"){
                        return UTLocalizationUtil.nationIdToName(value, services.Localization) || String(value);
                    }
                    if(type === "league"){
                        return UTLocalizationUtil.leagueIdToName(value, services.Localization) || String(value);
                    }
                    if(type === "club"){
                        return UTLocalizationUtil.teamIdToAbbr15(value, services.Localization) || String(value);
                    }
                } catch(error) {
                    return String(value);
                }
            ...
            const faceStats = Object.entries(statConfig).map(([key, config]) => {
                return {
                    key,
                    label: fy(`clubplayers.detail.face.${key}`),
                    value: events.getClubPlayerStatValue(player, config.id, true),
                    subStats: config.list.map(attributeId => {
                        const [localizationKey, fallback] = subAttributeLabels.get(attributeId) ?? ["", String(attributeId)];
                        return {
                            id: attributeId,
                            label: events.getClubPlayerSafeLocalized([
            ...
            const databaseId = player?.databaseId ?? player?.assetId;
            const playerMeta = info.playermeta?.[databaseId] ?? {};
            const height = Number(metaData?.height ?? staticData?.height ?? 0);
            const weight = Number(playerMeta?.weight ?? metaData?.weight ?? 0);
            const bodyTypeId = Number(playerMeta?.badytype ?? info.meta?.bodyType?.[databaseId] ?? 0);
            const bodyType = bodyTypeId > 0
                ? fy(`players.bodytype_${bodyTypeId}`)
                : "—";
            const positions = Array.from(new Set([record.position].concat(record.positions ?? [])
                .filter(position => position !== undefined && position !== null)));
            const preferredPosition = getPositionName(record.position);
            const alternatePositions = positions
                .filter(position => String(position) !== String(record.position))
                .map(getPositionName);
            const rarity = events.getClubPlayerSafeLocalized([`item.raretype${record.rarity}`], String(record.rarity ?? "—"));
            let accelerate = "—";
            if(!isGK && height > 0){
                try {
                    const accelerateCode = events.getAcceleRate(player);
                    accelerate = fy(`accelerate.type.${accelerateCode}`);
                } catch(error) {
                    accelerate = "—";
                }
            }
            const playStyles = events.getClubPlayerPlayStyles(player);
            const stars = value => Number(value) > 0 ? `${Number(value)} ★` : "—";
            const facts = [
                { label: fy("clubplayers.filter.nation"), value: getEntityName("nation", record.nation) },
                { label: fy("clubplayers.filter.club"), value: getEntityName("club", record.club) },
                { label: fy("clubplayers.filter.league"), value: getEntityName("league", record.league) },
                { label: fy("clubplayers.filter.rarity"), value: rarity },
                { label: fy("clubplayers.filter.foot"), value: fy(`clubplayers.foot.${record.foot}`) },
                { label: fy("clubplayers.filter.skills"), value: stars(record.skillMoves) },
                { label: fy("clubplayers.filter.weakfoot"), value: stars(record.weakFoot) },
                { label: fy("clubplayers.detail.positions"), value: alternatePositions.join(", ") || "—" },
                { label: fy("clubplayers.detail.height"), value: height > 0 ? `${height} cm` : "—" },
                { label: fy("clubplayers.detail.weight"), value: weight > 0 ? `${weight} kg` : "—" },
                { label: fy("clubplayers.detail.bodytype"), value: bodyType },
                { label: fy("clubplayers.detail.accelerate"), value: accelerate },
                { label: fy("clubplayers.filter.gender"), value: fy(`clubplayers.gender.${record.gender}`) },
                { label: fy("clubplayers.filter.location"), value: fy(`clubplayers.location.${record.location}`) },
                { label: fy("clubplayers.filter.tradeable"), value: fy(record.tradeable ? "clubplayers.tradeable.yes" : "clubplayers.tradeable.no") },
                { label: fy("clubplayers.detail.itemid"), value: String(player?.definitionId ?? "—") },
                { label: fy("clubplayers.detail.eaid"), value: String(databaseId ?? "—") }
            ];
            return {
                player,
                name: String(staticData?.name ?? record.name ?? player?.definitionId ?? "—"),
                rating: Number(record.rating ?? player?.rating ?? 0),
                preferredPosition,
                rarity,
                faceStats,
                facts,
        ...
        events.createClubPlayerDetailView = (record) => {
            const data = events.getClubPlayerDetailData(record);
            const root = events.createElementWithConfig("div", {
                classList: "fsu-clubPlayerDetail"
            });
            const hero = events.createElementWithConfig("div", {
                classList: "fsu-clubPlayerDetailHero"
            });
            const cardStage = events.createElementWithConfig("div", {
                classList: "fsu-clubPlayerDetailCardStage"
            });
            let itemView = null;
            try {
                itemView = UTItemViewFactory.createLargeItem(data.player);
                itemView.init();
                itemView.render(data.player);
                cardStage.appendChild(itemView.getRootElement());
            } catch(error) {
                itemView?.dealloc?.();
                itemView = null;
                const fallback = events.createElementWithConfig("div", {
                    classList: "fsu-clubPlayerDetailCardFallback"
                });
                fallback.appendChild(events.createElementWithConfig("strong", {
                    textContent: data.rating || "—"
                }));
                fallback.appendChild(events.createElementWithConfig("span", {
                    textContent: data.name
                }));
                cardStage.appendChild(fallback);
                console.warn("[FSU] Club player detail card render failed", record.itemKey, error);
            }
            hero.appendChild(cardStage);

            const summary = events.createElementWithConfig("div", {
                classList: "fsu-clubPlayerDetailSummary"
            });
            summary.appendChild(events.createElementWithConfig("div", {
                classList: "fsu-clubPlayerDetailEyebrow",
                textContent: fy("clubplayers.detail.info")
            }));
            summary.appendChild(events.createElementWithConfig("h2", {
                classList: "fsu-clubPlayerDetailName",
                textContent: data.name
            }));
            const identity = events.createElementWithConfig("div", {
                classList: "fsu-clubPlayerDetailIdentity"
            });
            identity.appendChild(events.createElementWithConfig("span", {
                classList: "fsu-clubPlayerDetailRating",
                textContent: data.rating || "—",
                attributes: {
                    "title": fy("clubplayers.detail.rating")
                }
            }));
            identity.appendChild(events.createElementWithConfig("span", {
                classList: ["fsu-clubPlayerDetailPill", "fsu-clubPlayerDetailPill--accent"],
                textContent: data.preferredPosition
            }));
            identity.appendChild(events.createElementWithConfig("span", {
                classList: "fsu-clubPlayerDetailPill",
                textContent: data.rarity
            }));
            summary.appendChild(identity);

            const faceGrid = events.createElementWithConfig("div", {
                classList: "fsu-clubPlayerDetailFaceGrid"
            });
            data.faceStats.forEach(stat => {
                const face = events.createElementWithConfig("div", {
                    classList: "fsu-clubPlayerDetailFace"
                });
                face.appendChild(events.createElementWithConfig("span", {
                    classList: ["fsu-clubPlayerDetailFaceValue", events.getClubPlayerStatTone(stat.value)].filter(Boolean),
                    textContent: stat.value ?? "—"
                }));
                face.appendChild(events.createElementWithConfig("span", {
                    classList: "fsu-clubPlayerDetailFaceLabel",
            ...
            summary.appendChild(faceGrid);

            const factGrid = events.createElementWithConfig("div", {
                classList: "fsu-clubPlayerDetailFactGrid"
            });
            data.facts.forEach(fact => {
                const factElement = events.createElementWithConfig("div", {
                    classList: "fsu-clubPlayerDetailFact"
                });
                factElement.appendChild(events.createElementWithConfig("div", {
                    classList: "fsu-clubPlayerDetailFactLabel",
                    textContent: fact.label,
                    attributes: {
                        "title": fact.label
                    }
                }));
                factElement.appendChild(events.createElementWithConfig("div", {
                    classList: "fsu-clubPlayerDetailFactValue",
                    textContent: fact.value,
                    attributes: {
                        "title": fact.value
                    }
                }));
                factGrid.appendChild(factElement);
            });
            summary.appendChild(factGrid);
            hero.appendChild(summary);
            root.appendChild(hero);

            const content = events.createElementWithConfig("div", {
                classList: "fsu-clubPlayerDetailContent"
            });
            const createSectionHeader = (title, count) => {
                const header = events.createElementWithConfig("div", {
                    classList: "fsu-clubPlayerDetailSectionHeader"
                });
                header.appendChild(events.createElementWithConfig("h3", {
                    classList: "fsu-clubPlayerDetailSectionTitle",
                    textContent: title
                }));
                header.appendChild(events.createElementWithConfig("span", {
                    classList: "fsu-clubPlayerDetailSectionCount",
                    textContent: String(count)
                }));
                return header;
            };

            const stylesSection = events.createElementWithConfig("section", {
                classList: "fsu-clubPlayerDetailSection"
            });
            const styleCount = data.playStyles.plus.length + data.playStyles.basic.length;
            stylesSection.appendChild(createSectionHeader(fy("clubplayers.detail.playstyles"), styleCount));
            const styleGroups = events.createElementWithConfig("div", {
                classList: "fsu-clubPlayerDetailStyleGroups"
            });
            const createStyleGroup = (styles, plus) => {
                const group = events.createElementWithConfig("div", {
                    classList: "fsu-clubPlayerDetailStyleGroup"
                });
                const title = events.createElementWithConfig("div", {
                    classList: "fsu-clubPlayerDetailStyleTitle"
                });
                title.appendChild(document.createTextNode(fy(plus ? "clubplayers.detail.playstyles.plus" : "clubplayers.detail.playstyles.basic")));
                title.appendChild(events.createElementWithConfig("span", {
                    textContent: String(styles.length)
                }));
                group.appendChild(title);
                const list = events.createElementWithConfig("div", {
                    classList: "fsu-clubPlayerDetailStyleList"
                });
                if(!styles.length){
                    list.appendChild(events.createElementWithConfig("span", {
                        classList: "fsu-clubPlayerDetailStyleEmpty",
                        textContent: fy("clubplayers.detail.playstyles.empty")
                    }));
                }
                styles.forEach(style => {
                    const traitId = Number(style?.traitId);
                    const name = events.getClubPlayerPlayStyleName(style);
                    const chip = events.createElementWithConfig("div", {
                        classList: plus
                            ? ["fsu-clubPlayerDetailStyleChip", "fsu-clubPlayerDetailStyleChip--plus"]
                            : "fsu-clubPlayerDetailStyleChip",
                        attributes: {
                            "title": name,
                            "aria-label": name
                        }
                    });
                    chip.appendChild(events.createElementWithConfig("i", {
                        classList: plus
                            ? ["fut_icon", "fsu-traitIcon", "icon", `icon_icontrait${traitId}`]
                            : ["fut_icon", "fsu-traitIcon", `icon_basetrait${traitId}`],
                        attributes: {
                            "aria-hidden": "true"
                        }
                    }));
                    chip.appendChild(events.createElementWithConfig("span", {
                        textContent: name
                    }));
            ...
            styleGroups.appendChild(createStyleGroup(data.playStyles.plus, true));
            styleGroups.appendChild(createStyleGroup(data.playStyles.basic, false));
            stylesSection.appendChild(styleGroups);
            content.appendChild(stylesSection);

            const attributesSection = events.createElementWithConfig("section", {
                classList: "fsu-clubPlayerDetailSection"
            });
            attributesSection.appendChild(createSectionHeader(fy("clubplayers.detail.attributes"), data.faceStats.length));
            const attributeGrid = events.createElementWithConfig("div", {
                classList: "fsu-clubPlayerDetailAttributeGrid"
            });
            data.faceStats.forEach(groupData => {
                const group = events.createElementWithConfig("div", {
                    classList: "fsu-clubPlayerDetailAttributeGroup"
                });
                const head = events.createElementWithConfig("div", {
                    classList: "fsu-clubPlayerDetailAttributeHead"
                });
                head.appendChild(events.createElementWithConfig("span", {
                    classList: "fsu-clubPlayerDetailAttributeName",
                    textContent: groupData.label
                }));
                head.appendChild(events.createElementWithConfig("span", {
                    classList: ["fsu-clubPlayerDetailAttributeValue", events.getClubPlayerStatTone(groupData.value)].filter(Boolean),
                    textContent: groupData.value ?? "—"
                }));
                group.appendChild(head);
                const subStats = events.createElementWithConfig("div", {
                    classList: "fsu-clubPlayerDetailSubStats"
                });
                groupData.subStats.forEach(stat => {
                    const row = events.createElementWithConfig("div", {
                        classList: "fsu-clubPlayerDetailSubStat"
                    });
                    row.appendChild(events.createElementWithConfig("span", {
                        classList: "fsu-clubPlayerDetailSubStatLabel",
                        textContent: stat.label,
                        attributes: {
                            "title": stat.label
                        }
                    ...
                    row.appendChild(events.createElementWithConfig("span", {
                        classList: ["fsu-clubPlayerDetailSubStatValue", events.getClubPlayerStatTone(stat.value)].filter(Boolean),
                        textContent: stat.value ?? "—"
                    }));
                    row.appendChild(events.createElementWithConfig("span", {
                        classList: "fsu-clubPlayerDetailSubStatBar",
                        var: {
                            "--fsu-stat-value": `${stat.value ?? 0}%`
                        },
                        attributes: {
                            "aria-hidden": "true"
                        }
                    }));
                    subStats.appendChild(row);
                });
                group.appendChild(subStats);
        ...
        events.ensureClubPlayerDetailMetadata = (player) => {
            ...
            return new Promise(resolve => {
                ...
                try {
                    services.PlayerMetaData.updateItemPlayerMeta([player]).observe(owner, function (token) {
                        try {
                            token.unobserve(owner);
                        } catch(error) {
                            // The timeout already makes this request non-blocking.
                        }
                        finish();
                    });
                } catch(error) {
        ...
        events.openClubPlayerDetail = async(record) => {
            ...
            events.clubPlayerDetailOpening = true;
            events.showLoader();
            let detailView = null;
            ...
            try {
                ...
                popupController = new EADialogViewController({
                    dialogOptions: [{ labelEnum: enums.UIDialogOptions.OK }],
                    message: "",
                ...
                if(!popupOwnsItemView){
                    detailView?.itemView?.dealloc?.();
                }
                console.error("[FSU] Club player detail popup failed", error);
                events.notice(fy("clubplayers.detail.error"), 2);
            } finally {
                events.hideLoader();
                events.clubPlayerDetailOpening = false;
            }
        }
        ...
        clubPlayersControllerView.prototype._disposePlayerCards = function () {
            if(!this._fsu){
                return;
            }
            _.forEach(this._fsu.detailControls, control => {
                control?.dealloc?.();
            })
            this._fsu.detailControls = [];
            _.forEach(this._fsu.itemViews, itemView => {
                itemView?.dealloc?.();
            })
            this._fsu.itemViews = [];
            if(this._fsu.listBox){
                this._fsu.listBox.innerHTML = "";
            }
        }
        clubPlayersControllerView.prototype._renderNextBatch = function () {
            ...
            try {
                _.forEach(batch, record => {
                    ...
                    this._fsu.detailControls.push(detailControl);
                    itemViewCard.appendChild(detailElement);
                    itemViewBox.appendChild(itemViewCard);
        ...
        clubPlayersControllerView.prototype._applyFilters = function () {
            ...
            const state = this._fsu.state;
            state.filtered = events.filterClubPlayerDashboardRecords(state.records, state);
            state.visible = 0;
            state.pageSize = state.columns * 6;
            this._fsu.resultText.textContent = fy(["clubplayers.results", state.filtered.length, state.records.length]);
            this._fsu.root.classList.toggle("is-empty", state.filtered.length === 0);
            if(state.filtered.length){
                this._renderNextBatch();
            }else{
                this._fsu.visibleText.textContent = fy(["clubplayers.visible", 0, 0]);
                this._fsu.loadMore.hidden = true;
            }
        }
        clubPlayersControllerView.prototype._setColumns = function (columns) {
            const value = Math.max(2, Math.min(4, Number(columns) || 3));
            this._fsu.state.columns = value;
            this._fsu.state.pageSize = value * 6;
            this._fsu.listBox.dataset.columns = String(value);
            this._fsu.listBox.style.setProperty("--fsu-club-player-columns", value);
            _.forEach(this._fsu.columnButtons, button => {
                button.setAttribute("aria-pressed", String(Number(button.dataset.columns) === value));
            })
            GM_setValue("clubplayers.columns", value);
        }
        clubPlayersControllerView.prototype._generate = function _generate() {
            if (!this._generated) {
                ...
                const toolbarTop = events.createElementWithConfig("div", {
                    classList: "fsu-clubPlayersToolbarTop"
                });
                const summary = events.createElementWithConfig("div", {
                    classList: "fsu-clubPlayersSummary"
                });
                const resultText = events.createElementWithConfig("div", {
                    classList: "fsu-clubPlayersResult",
                    attributes: {
                        "aria-live": "polite"
                    }
                });
                ...
                const actions = events.createElementWithConfig("div", {
                    classList: "fsu-clubPlayersActions"
                });
                const columnsBox = events.createElementWithConfig("div", {
                    classList: "fsu-clubPlayersColumns",
                    attributes: {
                        "role": "group",
                        "aria-label": fy("clubplayers.filter.columns")
                    }
                });
                columnsBox.appendChild(events.createElementWithConfig("span", {
                    classList: "fsu-clubPlayersColumnsLabel",
                ...
                const filters = events.createElementWithConfig("div", {
                    classList: "fsu-clubPlayersFilters"
                });
                const allOption = () => [{ value: "", label: fy("clubplayers.select.all") }];
                const getLocalizedLabel = (type, value) => {
                    try {
                        if(type === "position"){
                            return UTLocalizationUtil.positionIdToName(value, services.Localization) || String(value);
                        }
                        if(type === "nation"){
                            return UTLocalizationUtil.nationIdToName(value, services.Localization) || String(value);
                        }
                        ...
                        if(type === "rarity"){
                            return services.Localization.localize(`item.raretype${value}`) || String(value);
                        }
                    } catch(error) {
                        return String(value);
                    }
                ...
                const distinctOptions = (property, type) => {
                    const values = new Map();
                    _.forEach(state.records, record => {
                        const candidates = Array.isArray(record[property]) ? record[property] : [record[property]];
                        _.forEach(candidates, value => {
                            if(value !== undefined && value !== null && !values.has(String(value))){
                                values.set(String(value), getLocalizedLabel(type, value));
                            }
                        })
                    })
                ...
                const createControl = (label, extraClass) => {
                    const control = events.createElementWithConfig("div", {
                        classList: extraClass ? ["fsu-clubPlayersControl", extraClass] : "fsu-clubPlayersControl"
                    });
                    control.appendChild(events.createElementWithConfig("label", {
                        textContent: label
                    }));
                    return control;
                };
                const scheduleFilter = () => {
                    clearTimeout(this._fsu.filterTimer);
                    this._fsu.filterTimer = setTimeout(() => this._applyFilters(), 180);
                };
                const addInput = (label, key, config, extraClass) => {
                    const control = createControl(label, extraClass);
                    const input = events.createElementWithConfig("input", {
                        type: config.type,
                        value: "",
                ...
                const addSelect = (label, key, options) => {
                    ...
                    const select = events.createElementWithConfig("select", {
                        attributes: {
                            "aria-label": label
                        }
                    });
                    _.forEach(options, option => {
                        select.appendChild(events.createElementWithConfig("option", {
                    ...
                    this._fsu.controls[key] = select;
                    control.appendChild(select);
                    filters.appendChild(control);
                    return select;
                };

                addInput(fy("clubplayers.search"), "query", {
                    type: "search",
                    placeholder: fy("clubplayers.search")
                }, "fsu-clubPlayersControl--search");
                addInput(fy("clubplayers.filter.minovr"), "minRating", {
                    type: "number",
                    placeholder: "0",
                    min: 0,
                    max: 99,
                ...
                addInput(fy("clubplayers.filter.maxovr"), "maxRating", {
                    type: "number",
                    placeholder: "99",
                    min: 0,
                    max: 99,
                ...
                const positionControl = createControl(fy("clubplayers.filter.position"));
                const positionRow = events.createElementWithConfig("div", {
                    classList: "fsu-clubPlayersPositionRow"
                });
                const positionSelect = events.createElementWithConfig("select", {
                    attributes: {
                        "aria-label": fy("clubplayers.filter.position")
                    }
                });
                _.forEach(allOption().concat(distinctOptions("positions", "position")), option => {
                    positionSelect.appendChild(events.createElementWithConfig("option", {
                        value: String(option.value),
                        textContent: option.label
                    }));
                })
                ...
                this._fsu.controls.position = positionSelect;
                positionRow.appendChild(positionSelect);
                const primaryLabel = events.createElementWithConfig("label", {
                    classList: "fsu-clubPlayersPrimaryLabel"
                });
                const primaryCheckbox = events.createElementWithConfig("input", {
                    type: "checkbox",
                    attributes: {
                        "aria-label": fy("clubplayers.filter.primary")
                    }
                });
                primaryCheckbox.addEventListener("change", () => {
                    state.primaryOnly = primaryCheckbox.checked;
                    this._applyFilters();
                });
                this._fsu.controls.primaryOnly = primaryCheckbox;
                primaryLabel.appendChild(primaryCheckbox);
                primaryLabel.appendChild(document.createTextNode(fy("clubplayers.filter.primary")));
                positionRow.appendChild(primaryLabel);
                positionControl.appendChild(positionRow);
                filters.appendChild(positionControl);

                addSelect(fy("clubplayers.filter.quality"), "quality", allOption().concat([
                    { value: "bronze", label: fy("clubplayers.quality.bronze") },
                    { value: "silver", label: fy("clubplayers.quality.silver") },
                    { value: "gold", label: fy("clubplayers.quality.gold") },
                    { value: "special", label: fy("clubplayers.quality.special") }
                ]));
                addSelect(fy("clubplayers.filter.nation"), "nation", allOption().concat(distinctOptions("nation", "nation")));
                addSelect(fy("clubplayers.filter.league"), "league", allOption().concat(distinctOptions("league", "league")));
                addSelect(fy("clubplayers.filter.club"), "club", allOption().concat(distinctOptions("club", "club")));
                addSelect(fy("clubplayers.filter.rarity"), "rarity", allOption().concat(distinctOptions("rarity", "rarity")));
                const starOptions = allOption().concat(_.map(_.range(1, 6), value => ({ value, label: `${value} ★` })));
                addSelect(fy("clubplayers.filter.skills"), "skillMoves", starOptions);
                addSelect(fy("clubplayers.filter.weakfoot"), "weakFoot", starOptions);
                addSelect(fy("clubplayers.filter.foot"), "foot", allOption().concat([
                    { value: "left", label: fy("clubplayers.foot.left") },
                    { value: "right", label: fy("clubplayers.foot.right") }
                ]));
                addSelect(fy("clubplayers.filter.gender"), "gender", allOption().concat([
                ...
                addSelect(fy("clubplayers.filter.sort"), "sort", [
                    { value: "rating-desc", label: fy("clubplayers.sort.ratingdesc") },
                    { value: "rating-asc", label: fy("clubplayers.sort.ratingasc") },
                    { value: "name-asc", label: fy("clubplayers.sort.nameasc") },
                    { value: "name-desc", label: fy("clubplayers.sort.namedesc") }
                ]);
                toolbar.appendChild(filters);
                root.appendChild(toolbar);

                const listBox = events.createElementWithConfig("div", {
                    classList: "fsu-clubPlayersGrid"
                });
                ...
                const footer = events.createElementWithConfig("div", {
                    classList: "fsu-clubPlayersFooter"
                });
                const visibleText = events.createElementWithConfig("div", {
                    classList: "fsu-clubPlayersVisible",
                    attributes: {
                        "aria-live": "polite"
                    }
                });
                ...
                this._fsu.root = root;
                this._fsu.resultText = resultText;
                this._fsu.listBox = listBox;
        ...
        clubPlayersControllerView.prototype.dealloc = function () {
            if(this._fsu?.filterTimer){
                clearTimeout(this._fsu.filterTimer);
            }
            this._disposePlayerCards();
        ...
        JSUtils.inherits(clubPlayersController, EAViewController);
        clubPlayersController.prototype._getViewInstanceFromData = function () {
            return new clubPlayersControllerView();
        };
        clubPlayersController.prototype.viewDidAppear = function () {
            this.getNavigationController().setNavigationVisibility(true, true);
        };
        ...
        //26.07 FG计算
        //events.fgCalc(_.first(events.getItemBy(2, { id: 699914381216})))
        events.fgCalc = (player, first = true , shouldStore = true, styleId) => {
            if(player && _.has(info, "fgconfig")){
                ...
                if(!hasMeta){
                    if(_.has(info.playerMetaData, player.definitionId)){
                        if(!_.has(newPlayer.getMetaData(), "isLocal")){
                            ...
                            console.log('没应用缓存，重新设置' , newPlayer, newPlayer.getStaticData()?.name)
                        }
                    }else{
                        newPlayer = events.fgCreateVirtualPlayers(player);
                    }
                }
                ...
                for (const styleId of playStyles) {
                    const accele = events.getAcceleRate(newPlayer, 3 ,styleId);
                    const curve = events.getBoostedAttribute(newPlayer, styleId, 3, curveConfig.id);
                    const composure = events.getBoostedAttribute(newPlayer, styleId, 3, composureConfig.id);
                        ...
                        if(_.includes(posList, role.posId)){
                            ...
                            _.forEach(info.fgconfig.attribute, (attr, attrId) => {
                                if(_.has(factors, attrId)){
                                    let attribute = events.getBoostedAttribute(newPlayer, styleId, 3, attr.id)
                            ...
                            if(score > 0){
                                score = events.fgScoreToTargetRange(score).toFixed(1);
        ...
        // 26.07 FG系数缩放
        events.fgScoreToTargetRange = (rating) => {
            if(rating <= 0){
                return rating;
            }
            const {
        ...
        // 26.07 FG子属性预估计算
        events.fgCreateVirtualPlayers = (player) => {
        ...
        // 26.07 FG元素创造
        events.fgCreateElment = (element, playerFG) => {
            ...
            element.appendChild(events.createElementWithConfig("div", {
                textContent: playerFG.grade,
                style:{
                    color: metaTextColor,
        ...
        events.fgPopup = (player) => {
            ...
            const showPopup = (playerFG) => {
                ...
                let scrollWrapper = events.createElementWithConfig("div", {
                    style: {
                        maxHeight: "250px", 
                        overflowY: "auto",
                        position: "relative", 
                ...
                let table = events.createElementWithConfig("table", {
                    style: {
                        width: "100%",
                ...
                _.range(1, 6).forEach(i => {
                    theadTr.appendChild(
                        events.createElementWithConfig("th", {
                ...
                _.forEach(playerFG, (player, index) => {
                    ...
                    let tr = events.createElementWithConfig("tr", {
                        style: {
                    ...
                    _.forEach(columns, (key) => {
                        tr.appendChild(
                            events.createElementWithConfig("td", {
            ...
            if (!repositories.PlayerMeta.get(player.definitionId)) {
                services.PlayerMetaData.updateItemPlayerMeta([player]).observe(cntlr.current(), function (q, w) {
                    q.unobserve(cntlr.current());
                    if (w.success) {
                        player.setMetaData(repositories.PlayerMeta.get(player.definitionId));
                        let fgList = events.fgCalc(player, false);
                        let bigCard = document.querySelector(`.fsu-cards-meta[data-id='${player.id}']`);
                        if(bigCard){
                            events.fgCreateElment(bigCard, _.first(fgList));
                        }
                ...
                showPopup(info.fgList[player.id] || events.fgCalc(player, false))
            }
        }
            ...
            if (typeof url === "string" && url.includes("/attributes/metadata")) {
                this.addEventListener("load", function () {
                    try {
                        ...
                        _.forEach(data, (d) => {
                            if(!_.has(info.playerMetaData, d.defId)){
                                info.playerMetaData[d.defId] = {
                                    "a": d.ingameattribs ?? [],
                                    "b": d.rolePlus ?? [],
                                    "c": d.rolePlusPlus ?? []
                                };
                        ...
                        GM_setValue(`playerMetaData_${info.base.year}`, JSON.stringify(info.playerMetaData));
                    } catch (e) { }
                });
        ...
        // 26.07 拦截meta进行set赋值
        const UTItemEntityFactory_generateItemConstructorOptions = UTItemEntityFactory.prototype.generateItemConstructorOptions;
        UTItemEntityFactory.prototype.generateItemConstructorOptions = function(t) {
            let options = UTItemEntityFactory_generateItemConstructorOptions.call(this, t);
            if(options.definitionId && options.type == ItemType.PLAYER && _.has(info.playerMetaData, options.definitionId) && !repositories.PlayerMeta.has(options.definitionId)){
                options.metaData = events.setLocalMetaData(options, options.metaData);
                //console.log(options.definitionId, options);
            }
            return options;
        }
        const UTItemEntity_setMetaData = UTItemEntity.prototype.setMetaData;
        UTItemEntity.prototype.setMetaData = function (metaData) {
            UTItemEntity_setMetaData.call(this, metaData);
            if(this.definitionId && this.type == ItemType.PLAYER && _.has(info.playerMetaData, this.definitionId) && !repositories.PlayerMeta.has(this.definitionId)){
                this._metaData = events.setLocalMetaData(this, metaData)
            }
        }
        // 26.07 创建存储的meta
        events.setLocalMetaData = (player, metaData) => {
            const virtualMeta = info.playerMetaData[player.definitionId];
            if(virtualMeta){
                const copyMeta = _.cloneDeep(metaData);
                copyMeta.attributes = _.map(virtualMeta.a, (v, k) => {
                    return new UTPlayerSubAttributeVO(k, v)
                })
                copyMeta.rolePlus = _.map(virtualMeta.b, (v) => {
                    return services.PlayerMetaData.metaDAO.generatePlayerRoleVO(v)
                })
                copyMeta.rolePlusPlus = _.map(virtualMeta.c, (v) => {
                    return services.PlayerMetaData.metaDAO.generatePlayerRoleVO(v)
                })
                copyMeta.isLocal = true;
                return copyMeta
            }else{
                return metaData
            }
        ...
        //26.09 临时修复GK进化显示错误的问题
        //临时修复，如果出现问题，请删除。
        const UTAcademyUtils_getSubAttributeByUpgradeId = UTAcademyUtils.getSubAttributeByUpgradeId;
        UTAcademyUtils.getSubAttributeByUpgradeId = function(t) {
            switch (t) {
                case AcademyStatEnum.GK_SUB_DIVING:
                    return ItemSubAttribute.gkdiving;
                case AcademyStatEnum.GK_SUB_HANDLING:
                    return ItemSubAttribute.gkhandling;
                case AcademyStatEnum.GK_SUB_KICKING:
                    return ItemSubAttribute.gkkicking;
                case AcademyStatEnum.GK_SUB_REFLEXES:
                    return ItemSubAttribute.gkreflexes;
                case AcademyStatEnum.GK_SUB_POSITIONING_SUB:
                    return ItemSubAttribute.gkpositioning;
                default:
                    return UTAcademyUtils_getSubAttributeByUpgradeId.call(this, t)
            }
        }
    ...
    function futgg(){
        ...
        const academyRaw = JSON.parse(GM_getValue("academy", "{}"));

        function fastHack(obj) {
            if (!obj) return;

            const local = academyRaw;
            if (!local) return;
            if (obj.evolutions && Array.isArray(obj.evolutions)) {
                console.log("⚡ 命中 evolutions");
                for (let i = 0; i < obj.evolutions.length; i++) {
                    const evo = obj.evolutions[i];
                    if (!evo) continue;

                    const eaInfo = local[evo.eaId];

                    if (eaInfo) {
                        let category = eaInfo.category ? `[${eaInfo.category}]` : "";
                        evo.name = category + "-" + eaInfo.name;
                    }
                }
                return true;
            }
    ...
    function main(){
        ...
        if (_.includes(location.href,"fut.gg/")) {
            console.log('Detecting FUT.GG...');
            //futgg();
        }
        unsafeWindow._ = _;
    }
